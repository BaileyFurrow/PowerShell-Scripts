...
function Install-ADTDeployment {
    ...
    Write-ADTLogEntry -Message "This is a test app deployment with PSADT 4.1.0-RC."
    $progParams = @{
        StatusMessage       = 'Component 1'
        StatusMessageDetail = 'Installing component 1. It does stuff and things.'
        StatusBarPercentage = 25
    }
    Show-ADTInstallationProgress @progParams
    Start-Sleep -Seconds 5

    $progParams = @{
        StatusMessage       = 'Component 2'
        StatusMessageDetail = 'Installing component 2. It does more stuff and things.'
        StatusBarPercentage = 50
    }
    Show-ADTInstallationProgress @progParams
    Start-Sleep -Seconds 5

    $progParams = @{
        StatusMessage       = 'Component 3'
        StatusMessageDetail = 'Installing component 3. It does even more stuff and things!'
        StatusBarPercentage = 75
    }
    Show-ADTInstallationProgress @progParams
    Start-Sleep -Seconds 5
    ...
    if (!$adtSession.UseDefaultMsi) {
        Show-ADTInstallationPrompt -Message 'Nothing happened. Yay!' -ButtonRightText 'Cancel' -ButtonMiddleText 'OK' -Icon Information -NoWait
    }
}
